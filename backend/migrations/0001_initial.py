# Generated by Django 3.0.5 on 2020-05-19 10:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.UserType')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.Location')),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.User')),
            ],
        ),
    ]
